...
import { setStatusTxt, setIsGameOver, setCurrentMove, setPlayerTurn, setPlayerToWait } from '../../store/slices/game';
...
const NavigationPanel = forwardRef((_props, ref) => {
   ...
   const { areMovesLoaded, isGameOver, currentMove, currentRound, playerTurn, playerToWait } = useAppSelector((state) => state.game);
   ...
   useEffect(() => {
      ...
      for (let i = 0; i < pieceRef.current.length; i++){
         ...
         let correctRound = (currentMove % 2 === 0 && i > 15 ) ? 1 : 0;
         ...
         let correctOpacity = (currentMove % 2 === 0 && i <= 15 ) ? 1 : 0;
