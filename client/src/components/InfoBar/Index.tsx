...
import { formatPlayerName } from '../../utils/commonFunctions';
            ...
            <>
               ...
               { !showDetails &&
                  <div className="infobar_details">
                     <p className="tag">
                        <span className="value">{formatPlayerName(tags['white'])}</span>
                        <span>vs</span>
                        <span className="value">{formatPlayerName(tags['black'])}</span>
                        <span>:</span>
